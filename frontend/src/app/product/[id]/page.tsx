                            ...
                            <div className={styles.variationsSection}>
                                {Object.entries(variationTypes).map(([typeName, values]) => (
                                    <div key={typeName} className={styles.variationGroup}>
                                        ...
                                        {typeName.toLowerCase() === 'size' && (
                                            <div style={{ marginTop: '1rem', fontSize: '0.85rem', color: '#555', border: '1px dashed #e5e7eb', padding: '0.75rem 1rem', borderRadius: '8px', backgroundColor: '#f9fafb' }}>
                                                <strong style={{ display: 'block', marginBottom: '0.25rem', color: '#111827' }}>📏 Size Measurements:</strong>
                                                <ul style={{ margin: 0, paddingLeft: '1.2rem', lineHeight: 1.6 }}>
                                                    <li><strong>Small:</strong> 20 cm x 13 cm x 12 cm</li>
                                                    <li><strong>Medium:</strong> 26 cm x 15 cm x 16 cm</li>
                                                    <li><strong>Large:</strong> 45 cm x 25 cm x 25 cm</li>
                                                </ul>
                                            </div>
                                        )}
                                    </div>
