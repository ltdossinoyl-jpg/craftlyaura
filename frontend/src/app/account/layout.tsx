...
export default function AccountLayout({ children }: { children: React.ReactNode }) {
    ...
    if (!user) {
        return (
            <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f9fafb', paddingTop: '80px' }}>
                <div style={{ background: 'white', padding: '3rem 2rem', borderRadius: '1rem', boxShadow: '0 10px 25px rgba(0,0,0,0.05)', maxWidth: '400px', width: '90%', textAlign: 'center' }}>
                    <h1 style={{ fontSize: '1.8rem', fontWeight: 600, marginBottom: '0.5rem', fontFamily: 'var(--font-serif)' }}>Welcome Back</h1>
                    <p style={{ color: '#666', marginBottom: '2rem', fontSize: '0.9rem' }}>Log in or sign up to track orders, earn rewards, and join exclusive programs.</p>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', margin: '1.5rem 0' }}>
                        ...
                        <span style={{ padding: '0 10px', color: '#9ca3af', fontSize: '0.8rem' }}>OR QUICK LOGIN</span>
                        <div style={{ flex: 1, height: '1px', background: '#e5e7eb' }}></div>
                    </div>

                    <p style={{ fontSize: '0.75rem', color: '#888' }}>By tapping Continue with Google, you agree to our Terms and Privacy Policy.</p>
                </div>
            </div>
        );
    }
