        ...
        <div className={`container ${styles.page}`}>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.sectionText}>
                        Once your order ships, you will receive an email with a tracking number and a link to track your shipment in real time. If you have any questions about your delivery, please contact us at <strong>contact@craftlyaura.com</strong>.
                    </p>
                </div>
